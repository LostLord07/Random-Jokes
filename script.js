let jokes = [`Why did an old man fall in a well ?<br>
...
“I’m looking for the man who shot my paw!”`,
  ...
  `Why can’t you send a duck to space ?<br>
    Because the bill would be astronomical!`,

  `What does Jeff Bezos do before he goes to sleep ?<br>
    He puts his PJ - Amazon!`,

  `What happened when the world's tongue-twister champion got arrested?<br>,
They gave him a tough sentence!`,

  `What did the mama cow say to the calf ?<br>
    It’s pasture bedtime!`,

  `How does a vampire start a letter ?<br>
    Tomb it may concern!`,

  `What did one plate say to the other ?<br>
    Dinner is on me!`,

  `Why do hummingbirds hum ?<br>
    Because they don’t know the words!`,

  `What do sprinters eat before a race ?<br>
    Nothing.They fast!`,
...
Because she was just a little hoarse!`,
  ...
  `What do kids play when their mom is using the phone ?<br> Bored games.`,

  `What do you call an ant who fights crime ?<br> A vigilANTe!;`,

  `Why are snails slow ?<br> Because they’re carrying a house on their back.`,

  `What is the smartest insect ?<br> A spelling bee!;`,
